...
const SPR_RELEASE_DATA = {
  ...
  keyInsights: [
    "US SPR deliveries ongoing at 1.4 mb/day from Bryan Mound, Big Hill and West Hackberry — ~11 mb delivered through Day 8 (6.4% of 172.2 mb) — DOE",
    "Japan's JOGMEC commenced 2.5 mb release from Kikuma base on Mar 26; oil now flowing from 11 government and private facilities — Nippon.com",
    "14 European countries with 113 mb combined commitment begin releases today (Mar 28) per IEA end-of-March schedule — IEA",
    "South Korea enforced naphtha export ban from Mar 27, signaling tightening refined products market alongside 22.5 mb drawdown — ICIS",
    "Overall release progress at 7.7% (33.0 of 426.0 mb) on Day 17 of 120-day window — IEA/DOE data",
  ],
  sources: [
