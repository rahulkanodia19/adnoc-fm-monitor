...
const LAST_UPDATED = "2026-03-30T06:00:00Z";
...
const COUNTRY_STATUS_DATA = [
  ...
  },
  {
    ...
    production: {
      ...
      notes: {
        oil: "4 offshore mega-fields shut (~2.5M bpd); March exports avg ~4.4 mb/d (down from 7.1 Feb); East-West Pipeline at full 7M bpd capacity",
        ...
        ports: "Yanbu at record ~5M bpd crude + 700-900k bpd products; Yanbu port loading bottleneck (~4.5M bpd capacity); Ras Tanura at partial ops"
      }
    },
    events: [
      {
  ...
  },
  {
    ...
    summary: "Israeli strikes hit South Pars gas field (Phases 3-6, 14, 17-18). USAF raids on Kharg Island. Tehran fuel depots and refinery destroyed. IRGC tolled passage: 142 transits since Mar 1 (95% drop). Tangsiri killed Mar 26. Houthis launched 2nd operation Mar 29. Bandar Khamir struck Mar 29 (5 killed). Pentagon readying ground ops. Pakistan hosted 4-nation ceasefire talks Mar 29; Iran dismissed.",
    metrics: {
    ...
    events: [
      {
        date: "2026-03-29",
        title: "US-Israeli strikes hit Bandar Khamir port; Pentagon readies ground operations in Iran",
        description: "US-Israeli strikes bombed the port city of Bandar Khamir in southern Iran, killing at least 5 people and injuring 4 (IRNA). Pentagon preparing for weeks of limited ground operations including raids on Kharg Island and coastal sites near Hormuz — plans short of full invasion but could involve thousands of troops. Trump has not greenlit ground ops yet. Separately, UAE and Qatar intercepted Iranian drones on Day 30 of conflict. — Washington Post, Al Jazeera, Gulf News",
        isNew: true
      },
      {
        date: "2026-03-29",
        title: "Pakistan hosts 4-nation talks (Turkey, Egypt, Saudi) to broker end to Iran war",
        description: "Pakistan hosted foreign ministers from Turkey, Egypt, and Saudi Arabia to discuss 'possible ways to bring an early and permanent end to the war.' Pakistan facilitating indirect US-Iran talks; US 15-point ceasefire plan being deliberated by Iran. Houthis launched 2nd military operation against Israel (cruise missiles + drones) on Mar 29. Iran dismissed diplomatic overtures, warning any US troops 'would be on fire.' Next 48-72 hours considered critical. — NPR, Al Jazeera, US News, Fortune",
        isNew: true
      },
      {
        date: "2026-03-28",
    ...
    oilGasImpact: {
      severity: "critical",
      summary: "~476 kb/d crude + ~3.3 Bcf/d gas offline; Houthis launch 2nd operation; Pakistan hosts 4-nation talks",
      details: "South Pars Phases 3-6, 14, 17-18 struck at Asaluyeh on 18 Mar (~12% of Iran's gas output offline). Tehran Refinery (250 kb/d) destroyed on 8 Mar. Bandar Abbas Refinery curtailed. 30+ fuel depots destroyed across Tehran. Kharg Island raided 13 Mar - exports disrupted but Iran still loaded avg 1.84 mb/d crude in March (84% from Kharg per Kpler). Southern oil fields ~30% shut-in. IRGC tolled passage system: 142 transits since Mar 1 (95% drop from 2,652 same period 2025); tolls ~$2M per transit. Houthis joined war Mar 28 with missile on Israel; 2nd operation Mar 29 (cruise missiles + drones). Pakistan hosted Turkey/Egypt/Saudi talks Mar 29 to broker ceasefire. Bandar Khamir struck Mar 29 (5 killed). Pentagon readying weeks of ground operations including Kharg Island seizure (WaPo). Iran dismissed diplomatic talks, warning US troops 'would be on fire.'"
    },
    infrastructure: [
...
const SPR_RELEASE_DATA = {
  ...
  keyInsights: [
    ...
    "US SPR lending of 45.2 mb to oil companies underway from 3 Gulf Coast sites; deliveries ongoing at ~1.4 mb/day (~26.3% of 172.2 mb commitment)",
    "South Korea enforced naphtha export ban from Mar 27 alongside 6.0 mb already released from 22.5 mb commitment",
    "Overall release at ~45.2 of 426.0 mb (~10.6%) on Day 19 of 120-day window; US SPR has lent 45.2 mb to oil companies; next EIA weekly data expected Apr 1",
    "Brent $112.57/bbl, WTI $99.64 as of Mar 28 — 51% monthly surge; Goldman warns $135 if Hormuz + Bab al-Mandeb both close",
    "Houthis entered war Mar 28 with missile attack on Israel; 2nd operation launched Mar 29 with cruise missiles and drones; Bab al-Mandeb closure 'among our options' per deputy info minister — dual chokepoint risk now real"
  ],
  sources: [
